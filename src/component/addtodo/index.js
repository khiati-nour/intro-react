...
addtodo(newTodo)
    ...
    return(<div style={addTodoStyle}>
        ...
        <form style={{paddingTop:"50px", marginBottom:"50px",display:"block", alignContent:"center", textAlign:"center", alignItems:"centre"}} onSubmit={HandleSubmit}>
            <input style={{borderRadius:"10px", borderColor:"hotpink", width:"300px",padding:"5px"}} type="text" onChange={(e)=>setTitle(e.target.value)} value={title} placeholder="Enter a To Do" required/>
